...
/* 변수에 대입한 값 변경하기 */
number1 = 300; // number1 에 300 대입 (기존 값 10을 덮어 쓰기함 (10 -> 300))
number2 = 400;
...
//변수명이 중복되어 엎어쓰기되면
// 이전에 선언 해놓은 변수를 쓸수 없게 되는 문제가 생김
...
// 변수명 중복 오류 발생!
// let number3 = 500;   // 'number3 을  다시 선언할 수 없습니다.
...
/* typeof 연산자 : 번수/값의 자료형을 출력하는 연산자 */

/* undefined : 정의 되지 핞은 변수/값이 아직 대입되지 않았다 */
let undef; // 변수 선언
console.log("undef :", undef, typeof undef);

/* string(문자열) : "" 또는 '' 내부의 작성된 값 */
const name = "홍길동"; //쌍따옴표
console.log("name :", name, typeof name);

const phone = '01012341234'; // 홑따움표
