/*  JS 객체
    ...
    -(중요) Key 는 무조건 문자열(string)
        -> "Key", 'key', key (" ", '' 작성 안해도 string 으로 인식)
...
btn1.addEventListener("click", () => {
    ...
    //-------------------------------------------------------
    //2. 객체 내 key 값을 이요해 원하는 value 얻어오기
