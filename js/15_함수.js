...
/* #btn1 클락 시 # input1의 값을 읽어와 print1() 함수 호출 */
...
document.querySelector("#btn2a").addEventListener("click" , function(){
    ...
    */
    ...
    // arrayTest() 함수에서 arr2외 같은 배열을 참조해소 수정
    // -> 함수 수행후 돌아 와서도
    // 참조하고 있던 배열의 2번 인젝스 값이 변화되어 있음
...
btn2c.addEventListener("click" , function(){
    ...
    const sumFn = function(a, b){
        return a + b; //함수를 끝냄 + 값(a+b) 을 사지고 호출한 곳으로
                      //돌아간다
    }; 
